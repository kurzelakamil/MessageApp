...
<body>
	<div class="container">
		<div class="jumbotron row align-items-center">
			...
			<ul>
				<li style="display: inline"><a href="/MessageApp/Homepage" role="button" class="btn btn-primary" name="message">Homepage<span class="badge badge-light"></span></a></li>
				...
				<c:forEach items="${messages}" var="item">
					<div class="container">
						<div class="row">
							...
							<div class="col-md-4">
								<c:out value="${item.createdDate}"></c:out>
							</div>
						</div>
					</div>
				</c:forEach>		
